...
fn bench(c: &mut Criterion) {
    ...
    group.bench_function("j17p1", |b| b.iter(|| { j17::_p1(black_box(include_str!("j17/j17.txt"))); }));
    group.bench_function("j17p2", |b| b.iter(|| { j17::_p2(black_box(include_str!("j17/j17.txt"))); }));
    group.finish();
}
